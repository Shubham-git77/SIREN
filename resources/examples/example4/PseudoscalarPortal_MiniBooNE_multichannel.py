...
Adapted from the working vector multichannel script:
  - production mediator_type="pseudoscalar", pdgid_mediator=5919 (phi)
...
def main():
    ...
    ax[0].set_title("MiniBooNE Pseudoscalar Primakoff : photon energy"); ax[0].legend(fontsize=8)
    ax[1].set_xlabel("cos(theta) wrt beam"); ax[1].set_ylabel("Events / %g POT" % MINIBOONE_POT)
    ax[1].set_title("MiniBooNE Pseudoscalar Primakoff : photon angular"); ax[1].legend(fontsize=8)
