...
def main():
    ...
    if args.engine == "analytic":
        res = _AR.report_detector(sys.modules[__name__], "ICARUS pseudoscalar a->gamma",
                                  "icarus", vector=False, n_dec=args.n_dec)
        os.makedirs("output", exist_ok=True)
        _out = "output/ICARUS_pseudo_analytic.npz"
    ...
    ax[0].set_title(r"ICARUS pseudoscalar Dark Primakoff: $E_\gamma$ " + pot_note,
                    fontsize=10)
    ...
    ax[1].set_title(r"ICARUS pseudoscalar Dark Primakoff: $\cos\theta$ wrt beam " + pot_note,
                    fontsize=10)
    ...
    ax[2].set_title(r"ICARUS pseudoscalar Dark Primakoff: $\cos\theta$ zoom $[0.80,1.0]$ " + pot_note,
                    fontsize=10)
