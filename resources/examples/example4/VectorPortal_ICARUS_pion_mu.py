...
M_LEPTON    = 0.10566    # GeV — 0.10566 for μ, 0.000511 for e
M_MESON     = 0.13957    # GeV — 0.13957 for π, 0.49368 for K
flux_tag    = "pion_numu"    # pion_numu / pion_nue / kaon_numu / kaon_nue
output_stem = "output/ICARUS_VectorPortal_pion_mu"
...
def compute_chi_flux(flux_tag, m_meson, m_lepton, m_V1, min_energy, max_energy,
    ...
    for E_meson in meson_energies:
        ...
        chi_flux_vals.append(raw_flux.SamplePDF(E_meson))
...
chi_E_phys, chi_F_phys = compute_chi_flux(
    ...
    min_energy=E_thresh, max_energy=3.0, physically_normalized=True,
)
chi_E_gen, chi_F_gen = compute_chi_flux(
    flux_tag, M_MESON, M_LEPTON, M_V1,
    min_energy=E_thresh, max_energy=3.0, physically_normalized=False,
)
...
position_distribution  = siren.distributions.ColumnDepthPositionDistribution(
    5.0, 5.0, siren.distributions.LeptonDepthFunction()  # ICARUS z half-length
)
