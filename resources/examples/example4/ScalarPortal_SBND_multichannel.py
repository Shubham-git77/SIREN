"""
Long-lived SCALAR (phi) Dark Primakoff chain at SBND (LAr)  —  MULTICHANNEL sum.
...
def main():
    ...
    if args.engine == "analytic":
        ...
        res = sbnd_analytic.report_detector(sys.modules[__name__], "SBND scalar phi->gamma", "sbnd",
    ...
    print("\n" + "=" * 64)
    print("  MULTICHANNEL SUM  —  SBND Scalar Dark Primakoff")
    print("=" * 64)
    ...
    os.makedirs("output", exist_ok=True)
    stem = "output/SBND_ScalarPrimakoff_multichannel"
    ...
    ax[0].set_title(r"SBND scalar Dark Primakoff: $E_\gamma$ " + pot_note,
                    fontsize=10)
    ...
    ax[1].set_title(r"SBND scalar Dark Primakoff: $\cos\theta$ wrt beam " + pot_note,
                    fontsize=10)
    ...
    ax[2].set_title(r"SBND scalar Dark Primakoff: $\cos\theta$ zoom $[0.80,1.0]$ " + pot_note,
                    fontsize=10)
