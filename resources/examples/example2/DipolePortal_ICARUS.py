...
fiducial_volume = siren.utilities.get_fiducial_volume("ICARUS")
...
if len(events) > 0:
    SaveEvents(events,weighter,gen_times,output_filename="output/ICARUS_Dipole")
else:
    print("No valid events generated — skipping SaveEvents.")
