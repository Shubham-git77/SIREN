...
injector.primary_injection_distributions = [
    ...
    # Direction (uni-directional beam)
    ...
    siren.distributions.ColumnDepthPositionDistribution(
        0.6, 1.0,
        siren.distributions.LeptonDepthFunction()
    )
]
...
SaveEvents(events, weighter, gen_times, output_filename="output/UnidirectionalICARUS_DIS")
