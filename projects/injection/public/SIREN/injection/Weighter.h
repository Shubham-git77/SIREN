...
struct VertexWeightFactors {
    ...
    // Convention shared by every value in channel_densities. The pair is kept
    // as separate fields on this pre-azimuth branch; after s02 is restacked it
    // is the same information carried by PhaseSpaceConvention.
